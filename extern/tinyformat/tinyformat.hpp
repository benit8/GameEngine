...
#include <sstream>
	...
	// std::showpos is broken on old libstdc++ as provided with macOS.
	// See http://gcc.gnu.org/ml/libstdc++/2007-11/msg00075.html
...
template<typename T>
struct is_wchar { typedef int tinyformat_wchar_is_not_supported; };
