...
MessageBox::~MessageBox()
{
	...
	Application::getInstance()->window().setCursor(sf::Cursor::Arrow);
}
...
{
	unsigned maxWidth = Application::getInstance()->window().width() * 0.75f;
	...
	updatePositions(Application::getInstance()->window().getSize());
